...
namespace _06_2
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Dictionary<BankKey, int> seenAtIter = new Dictionary<BankKey, int>();
			...
			while (!seenAtIter.TryGetValue(key, out previousIter))
			{
				seenAtIter[key] = iterations;
			...
			Console.WriteLine(iterations - previousIter);
		}
